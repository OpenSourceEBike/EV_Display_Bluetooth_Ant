...
} antplus_lev_page_34_data_layout_t;

void antplus_lev_page_34_encode(uint8_t * p_page_buffer,
                            antplus_lev_page_34_data_t const * p_page_data,
                            antplus_lev_common_data_t const * p_common_data)
{
    antplus_lev_page_34_data_layout_t * p_outcoming_data = (antplus_lev_page_34_data_layout_t *)p_page_buffer;
