 ...
 * modern displays)
 *
 * remove call to UG_SetRefresh, it is very expensive.  Much better to just call display_show() from screenUpdate()
 *
 * define a screen as:
 *
...
#define SCREENCLICK_EXIT_SCROLLABLE M_LONG_CLICK
#define SCREENCLICK_NEXT_SCREEN M_CLICK
#define SCREENCLICK_ENTER_CONFIGURATIONS UPDOWN_LONG_CLICK
#define SCREENCLICK_START_CUSTOMIZING M_CLICK_LONG_CLICK
#define SCREENCLICK_STOP_CUSTOMIZING M_LONG_CLICK
#define SCREENCLICK_ALTERNATE_FIELD_START M_LONG_CLICK
#define SCREENCLICK_ALTERNATE_FIELD_STOP M_LONG_CLICK
#define SCREENCLICK_STREET_MODE ONOFFDOWN_LONG_CLICK
#define SCREENCLICK_ANT_CONTROLS_PAGE_MOVE_FORWARD ONOFF_CLICK
#define SCREENCLICK_ANT_CONTROLS_PAGE_MOVE_BACKWARD ONOFF_LONG_CLICK
