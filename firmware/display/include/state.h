...
typedef enum {
  MOTOR_INIT_OFF = 0,
  MOTOR_INIT_READY = 1,
  MOTOR_INIT_GET_MOTOR_ALIVE = 2,
  MOTOR_INIT_WAIT_MOTOR_ALIVE = 3,
  MOTOR_INIT_ERROR_ALIVE = 4,
  MOTOR_INIT_GET_MOTOR_FIRMWARE_VERSION = 5,
  MOTOR_INIT_WAIT_MOTOR_FIRMWARE_VERSION = 6,
  MOTOR_INIT_GOT_MOTOR_FIRMWARE_VERSION = 7,
  MOTOR_INIT_ERROR_GET_FIRMWARE_VERSION = 8,
  MOTOR_INIT_RECEIVED_MOTOR_FIRMWARE_VERSION = 9,
  MOTOR_INIT_ERROR_FIRMWARE_VERSION = 10,
  MOTOR_INIT_SET_CONFIGURATIONS = 11,
  MOTOR_INIT_WAIT_CONFIGURATIONS_OK = 12,
  MOTOR_INIT_WAIT_GOT_CONFIGURATIONS_OK = 13,
  MOTOR_INIT_ERROR_SET_CONFIGURATIONS = 14,
} motor_init_state_t;
...
extern volatile motor_init_state_config_t g_motor_init_state_conf;
...
typedef struct ui_vars_struct {
	...
	uint16_t ui16_wheel_max_speed_x100;
	uint16_t ui16_wheel_size;
//	uint8_t ui8_g_configuration_assist_levels;
#endif
	uint8_t ui8_units_type;
	uint32_t ui32_wh_x10_offset;
	uint32_t ui32_wh_x10_100_percent;
