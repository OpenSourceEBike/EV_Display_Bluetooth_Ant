...
static Field wheelMenus[] =
    {
        ...
        FIELD_EDITABLE_UINT("Wheel size", &ui_vars.ui16_wheel_size, "inch", 100, 300, .div_digits = 1, .inc_step = 5, .onSetEditable = onSetConfigurationChangeWheelSize),
        FIELD_EDITABLE_UINT(_S("Circumference", "Circumfere"), &ui_vars.ui16_wheel_perimeter, "mm", 750, 3000, .inc_step = 5, .onSetEditable = onSetConfigurationChangeWheelPerimeter),
#endif
        FIELD_END};
